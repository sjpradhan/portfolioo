...
class Uni_Course_Loader {
	 ...
	 * @return void
	 */
	public function uni_course_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function uni_course_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function uni_course_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function uni_course_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->uni_course_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function uni_course_load( $class ) {
