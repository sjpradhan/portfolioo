<?php
  ...
  * Slug: fse-education-school/404-header-with-background
  */
?>
...
<div class="wp-block-group alignfull no-margin-top">
	...
	<div class="wp-block-group alignfull" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
		<!-- wp:cover {"url":"<?php echo get_parent_theme_file_uri( '/assets/images/banner.png' ); ?>","dimRatio":0,"overlayColor":"body-text"} -->
		<div class="wp-block-cover">
			...
			<img class="wp-block-cover__image-background" alt="" src="<?php echo get_parent_theme_file_uri( '/assets/images/banner.png' ); ?>" data-object-fit="cover"/>
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide">
						...
						<h1 class="has-text-align-center has-text-color-foreground has-foreground-color has-text-color"><?php esc_html_e( '404 Nothing Found', 'fse-education-school' ); ?></h1>
						<!-- /wp:heading -->
						<!-- wp:paragraph {"textAlign":"center"} -->
						<p class="has-text-align-center"><?php esc_html_e( 'Oops! That page can\'t be found', 'fse-education-school' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
